            ...
            <div className="bg-white">
              ...
              {/** Admin */}
                {props.auth===1 && <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                      <div onClick={()=>{history.push('dashboard/view')}} className="p-6 max-w-sm cursor-pointer bg-yellow-300 rounded-xl shadow-md flex items-center space-x-4">
                        ...
                        <div className="p-6 max-w-sm cursor-pointer bg-red-400 rounded-xl shadow-md flex items-center space-x-4">
                            <div className="flex-shrink-0">
