             ...
             <div class="space-y-2">
              ...
              {/** Admin */}
                {props.auth===1 && <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                      <div onClick={()=>{history.push('/dashboard/confirmAppointments')}} className="p-6 max-w-sm cursor-pointer bg-yellow-300 rounded-xl shadow-md flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500  text-3xl font-bold">{count.appointments_not_confirmed}</p>
                            </div>

                        </div>
                        <div onClick={()=>{history.push('/dashboard/viewEmployees')}} className="p-6 max-w-sm cursor-pointer bg-red-400 rounded-xl shadow-md flex items-center space-x-4">
                            <div className="flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500  text-3xl font-bold"> {count.employee}</p>
                            </div>
                        ...
                        <div onClick={()=>{history.push('/dashboard/createAppointment')}} className="p-6 max-w-sm cursor-pointer bg-green-300 rounded-xl shadow-md flex items-center space-x-4">
                            <div className="flex-shrink-0">
                        ...
                        <div onClick={()=>{history.push('/dashboard/scheduledAppointments')}} className="p-6 max-w-sm cursor-pointer  bg-purple-300 rounded-xl shadow-md flex items-center space-x-4">
                            <div className="flex-shrink-0">
                            ...
                            <div>
                                ...
                                <p className="text-gray-500  text-3xl font-bold"> {count.appointments_confirmed}</p>
                            </div>
