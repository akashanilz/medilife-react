    ...
    <div className="dash_body">
      <div className="">
        <div className="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:max-h-7xl lg:px-8">
          ...
          <div onClick={() => { history.push('/dashboard/createAppointment') }} className="p-6 max-w-sm cursor-pointer bg-gray-500 rounded-xl shadow-md flex items-center space-x-4">
              ...
              <div>
                <div className="text-xl font-medium text-white">Create Appointment</div>
            ...
            <div onClick={() => { history.push('/dashboard/confirmAppointments') }} className="p-6 max-w-sm cursor-pointer bg-yellow-500 rounded-xl shadow-md flex items-center space-x-4">
              ...
              <div>
                <div className="text-xl font-bold text-dark">Confirm Appointments</div>
                <p className="text-white-500  text-3xl font-bold text-dark">{count.appointments_not_confirmed}</p>
              </div>

            </div>
            <div onClick={() => { history.push('/dashboard/viewCompletedAppointments') }} className="p-6 max-w-sm cursor-pointer bg-red-500 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
              ...
              <div>
                ...
                -medium text-black font-bold">Appointments Completed</div>
                <p className="text-white-500  text-3xl font-bold"> {count.appointments_completed}</p>
              </div>

            </div>
     
            <div onClick={() => { history.push('/dashboard/viewEmployees') }} className="p-6 max-w-sm cursor-pointer bg-blue-800 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
              ...
              <div>
                <div className="text-xl font-medium text-white">Total Nurses</div>
                <p className="text-white  text-3xl font-bold">{count.employee} </p>
              </div>

            </div>
            <div onClick={() => { history.push('/dashboard/viewDrivers') }} className="p-6 max-w-sm cursor-pointer bg-green-400 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
                <svg class="h-8 w-8 text-black" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M8 13.5a4 4 0 1 0 4 0v-8.5a2 2 0 0 0 -4 0v8.5" />  <line x1="8" y1="9" x2="12" y2="9" />  <line x1="16" y1="9" x2="22" y2="9" />  <line x1="19" y1="6" x2="19" y2="12" /></svg>
              </div>
              <div>
                <div className="text-xl font-medium text-black">Total Transporters</div>
            ...
            <div onClick={() => { history.push('/dashboard/scheduledAppointments') }} className="p-6 max-w-sm cursor-pointer  bg-yellow-50 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
          ...
          {props.auth === 2 && <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            ...
            <div onClick={() => { history.push('/dashboard/viewMyTasks') }} className="p-6 max-w-sm cursor-pointer bg-red-500 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
            ...
            <div onClick={() => { history.push('/dashboard/viewCompletedTasks') }} className="p-6 max-w-sm cursor-pointer bg-yellow-50 rounded-xl shadow-md flex items-center space-x-4">
              <div className="flex-shrink-0">
                <svg class="h-8 w-8 text-black" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z" />  <path d="M9 5H7a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2V7a2 2 0 0 0 -2 -2h-2" />  <rect x="9" y="3" width="6" height="4" rx="2" />  <path d="M9 14l2 2l4 -4" /></svg>
              </div>
              <div>
